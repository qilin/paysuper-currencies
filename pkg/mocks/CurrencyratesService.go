...
func (_m *CurrencyratesService) GetCurrenciesPrecision(ctx context.Context, in *currencies.EmptyRequest, opts ...client.CallOption) (*currencies.CurrenciesPrecisionResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *currencies.CurrenciesPrecisionResponse
	if rf, ok := ret.Get(0).(func(context.Context, *currencies.EmptyRequest, ...client.CallOption) *currencies.CurrenciesPrecisionResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*currencies.CurrenciesPrecisionResponse)
		}
	}
